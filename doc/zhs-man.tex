...
%	071211	Updated document, added description on zhmath and zhfont.
...
somewhat independent with the main text size; however, currently zhmath uses
\cs{f@size} to determine the main text size and is able to adjust the script font sizes
respectively. In |noactive| mode, although Chinese math font size varies with
the main font size, Chinese inside \cs{mathrm} etc cannot be displayed,
because the math font family are set to \cs{mathrm}'s. 
